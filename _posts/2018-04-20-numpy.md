...
print(np.amin(a))  
print(np.amin(a,1))    # 沿x轴
print(np.amin(a,0))    # 沿y轴
print(np.amax(a))
print(np.amax(a,1))    # 沿x轴
print(np.amax(a, axis =  0))   # 沿y轴
```
...
a = np.array([[3,7,5],[8,4,3],[2,4,9]])  
print(np.ptp(a))
print(np.ptp(a, axis = 1))   # 沿x轴
print(np.ptp(a, axis = 0))   # 沿y轴
```
...
print(np.percentile(a,50, axis = 1))   # 沿x轴
print(np.percentile(a,50, axis = 0))   # 沿y轴
```
